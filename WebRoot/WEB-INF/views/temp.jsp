			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class="active dropdown menu__item menu__item--current">
			...
			<div class="row">
				...
				<div class="col-md-8 panel panel-default" style="word-wrap:break-word;">
					<div class="col-xs-10 col-sm-12">
						<h1 align="center">COMING UP SOON! </h1>
						<h3 align="center">Unpublished Results</h3>
						<h3 align="center">Please <a href="<%=path%>/">click</a> here for redirecting to the index page</h3>
					</div>
				</div>
				<div class="col-md-2">
				</div>
